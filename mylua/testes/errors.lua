...
assert(doit("table.unpack({}, 1, 2^30)"))-- mod@om 原来的例子有毒，用了个 n=2^30 的语法。
...
-- checkmessage("a=(1)..{}", "a table value") -- mod@om 现在支持任意的字符串连接
...
-- checkmessage([[x = print .. "a"]], "concatenate") -- mod@om 
-- checkmessage([[x = "a" .. false]], "concatenate") -- mod@om 
-- checkmessage([[x = {} .. 2]], "concatenate") -- mod@om 
