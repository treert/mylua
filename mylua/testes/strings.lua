...
assert(string.char(string.byte("\xe4l\0óu", 1, -1)) == "\xe4l\0óu")-- mod@om
assert(string.char(string.byte("\xe4l\0óu", 1, 0)) == "")-- mod@om
assert(string.char(string.byte("\xe4l\0óu", -10, 100)) == "\xe4l\0óu")-- mod@om
...
assert(string.rep('tés\00tê', 2) == 'tés\0têtés\000tê')-- mod@om
...
if not _port then
  ...
  if trylocale("collate")  then
    assert("alo" < "álo" and "álo" < "amo")-- mod@om
  end

  if trylocale("ctype") then
    assert(string.gsub("áéíóú", "%a", "x") == "xxxxx")-- mod@om
    assert(string.gsub("áÁéÉ", "%l", "x") == "xÁxÉ")-- mod@om
    assert(string.gsub("áÁéÉ", "%u", "x") == "áxéx")-- mod@om
    assert(string.upper"áÁé{xuxu}ção" == "ÁÁÉ{XUXU}ÇÃO")-- mod@om
  end
